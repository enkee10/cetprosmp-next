...
export const INSERT_CARRERA_MUTATION = `
  mutation InsertCarrera($data: Carrera_Data! @allow(fields: "nombre codigo descripcion nivel ciclo codigoLag imagenPortadaUrl creadoEn actualizadoEn actEconomicaId especialidadId tipoCarreraId")) {
    carrera_insert(data: $data)
  }
`;

export const UPDATE_CARRERA_MUTATION = `
  mutation UpdateCarrera($id: Int!, $data: Carrera_Data! @allow(fields: "nombre codigo descripcion nivel ciclo codigoLag imagenPortadaUrl creadoEn actualizadoEn actEconomicaId especialidadId tipoCarreraId")) {
