...
async function generateCarnetAvatarImage(params: {
  ...
  prompt = [
    ...
    "El cabello y el peinado son parte de la identidad: manten exactamente el mismo cabello, largo, volumen, silueta, raya, flequillo, recogido, colitas, flecos o mechones que sobresalen en la parte inferior de la cabeza, linea de cabello y color de la referencia.",
    "No alises, no rices, no ordenes, no estilices, no cambies volumen, no cambies direccion del cabello, no quites colitas ni flecos de cabello inferiores, ni inventes un peinado nuevo aunque la referencia sea borrosa.",
    ageInstruction,
    ...
    "Composicion: centra a la persona en la imagen final; la cabeza, rostro, cuello y hombros deben quedar alineados al eje vertical central; si la cabeza esta minimamente inclinada o girada, corrigela de forma leve para enderezarla y que se vea totalmente de frente.",
