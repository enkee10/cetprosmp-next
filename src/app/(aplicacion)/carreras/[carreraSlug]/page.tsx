...
export async function generateMetadata({
  ...
  const carreras: Carrera[] = await getCarreras();
  const carrera = carreras.find((e) => e.slug === carreraSlug);

  if (!carrera) return {};

  return {
    title: `${carrera.tituloComercial} | CETPRO SMP`,
    description: `Conoce la carrera de ${carrera.tituloComercial} en el CETPRO San Martin de Porres.`,
  };
}
      ...
      <Container sx={{ pt: 5, mb: 6 }}>
        ...
        {modulosSinCodigo.length > 0 && (
          <Box mt={8}>
            ...
            <ListaModulos modulos={modulosSinCodigo} carreraSlug={carreraSlug} />
          </Box>
        )}
      </Container>
