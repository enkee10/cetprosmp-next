'use client'; // + marca esta configuración de Firebase web para uso exclusivo en el cliente
...
export { app, auth, db, storage }; // + exporta solo los servicios web usados realmente por la aplicación
